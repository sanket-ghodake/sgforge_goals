# Goals Micro-App - Views Directory (`src/frontend/views/`)

Houses HTML/TS view renderer components:

- `layout.ts`: Master shell layout with 100% full-width header bar, sub-header floating sidebar, and client SPA navigation router.
- `layout-styles.ts`: Master CSS tokens and Option 2 Deep Indigo (`#4F46E5`) + Electric Violet (`#7C3AED`) palette styling.
