...
export function getDevComments(now: number) {
  const oneDay = 24 * 60 * 60 * 1000;
  return [
    { id: 'comm-aditi-1', boardId: 'board-aditi-wal', itemId: null, authorId: 'usr-alice-eng', authorName: 'Aditi Sharma', authorRole: 'Senior Distributed Systems Engineer', commentText: 'Submitted goal plan for Q3 commitment. Benchmarks and replication benchmarks are ready.', type: 'FEEDBACK', createdAt: now - 2 * oneDay },
