...
const tools: ToolTest[] = [
  ...
  { name: 'AST Complexity Engine', command: ['bun', './scripts/quality/ast-complexity.ts'], category: 'Metrics & Quality' },
  { name: 'Package Health Guard', command: ['bun', './scripts/quality/check-package-health.ts'], category: 'Supply Chain Anti-Slop' },
